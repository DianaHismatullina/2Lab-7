...
int main()
{
	...
	cout << "Print the size of the Matrices:" << endl;
	cout << "Lines: "; cin >> lines;
	cout << "Columns: "; cin >> columns;
	cout << endl << "Main Matrix: " << endl;
	Matrix<double> Matr1(lines, columns);
	cout << Matr1;
	cout << endl << "Matrix for summation and multiplication: " << endl;
	Matrix<double> Matr2(lines, columns);
	cout << Matr2;
	cout << endl << "Result of summation:" << endl << Matr1 + Matr2;
	cout << endl << "Result of multiplication:" << endl << Matr1 * Matr2;
	if (Matr1 == Matr2)
		cout << endl << "Main Matrix = Matrix for summation and multiplication";
	_getch();
    return 0;
}
